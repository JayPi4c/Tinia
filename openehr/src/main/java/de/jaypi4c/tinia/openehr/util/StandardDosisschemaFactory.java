...
import de.jaypi4c.tinia.openehr.entities.nephromedikationcomposition.definition.*;
...
public class StandardDosisschemaFactory extends MedicationParser {
    ...
    public StandardDosisschemaFactory(DarreichungsformHelper darreichungsformHelper, EinheitenHelper einheitenHelper) {
        super(darreichungsformHelper, einheitenHelper);
    }
