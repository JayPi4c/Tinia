package com.jaypi4c.tinia.backend.service;

import com.jaypi4c.tinia.backend.config.RabbitConfig;
import com.jaypi4c.tinia.backend.dto.internal.ExtractorJob;
    ...
    public void process(MultipartFile file, boolean ocr) {
        ...
        try {
            ...
            for (int page = 0; page < document.getNumberOfPages(); page++) {
                rabbitTemplate.convertAndSend(RabbitConfig.EXTRACTOR_JOBS_QUEUE, new ExtractorJob(fileId, page, file.getBytes()));
            }
        } catch (IOException e) {
