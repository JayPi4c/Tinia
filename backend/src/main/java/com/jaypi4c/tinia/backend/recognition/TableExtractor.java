package com.jaypi4c.tinia.backend.recognition;

import com.jaypi4c.tinia.backend.recognition.preprocessing.CellIdentifier;
import com.jaypi4c.tinia.backend.recognition.preprocessing.ImageUtils;
import com.jaypi4c.tinia.backend.recognition.preprocessing.LineExtractor;
...
public class TableExtractor {
    ...
    @Value("${tinia.pdf.dpi}")
    private int DPI;
    @Value("${tinia.skipWhenNoHeaderFound}")
